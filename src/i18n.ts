  ...
  en: {
    translation: {
      ...
      intlCurrencyWithOptions:
        "The value is {{val, currency(currency: USD),locale}}",
      intlDateTime: "{{val, datetime,locale}}",
      intlRelativeTimeWithOptions: "{{val, relativetime(days)}}",
      WelcomeTitle: "Welcome to blogs",
      View: "View",
      CreateBlog: "Create a blog",
      AddBlog: "Add a Blog",
      EmptyBlogAlert: "Cant create blogs with empty body or title",
      Add: "Add",
      Cancel: "Cancel",
      ...
      EmptyCommentAlert: "Please enter something!",
    },
  },
  ka: {
    translation: {
      ...
      intlCurrencyWithOptions:
        "ಮೌಲ್ಯವು {{val, currency(currency: USD),locale}} ಆಗಿದೆ",
      intlDateTime: "{{val, datetime}}",
      intlRelativeTimeWithOptions: "{{val, relativetime(hour)}}",
    },
  },
  te: {
    translation: {
      ...
      intlCurrencyWithOptions: "విలువ {{val, currency(currency: USD),locale}}",
      intlDateTime: "{{val, datetime}}",
      intlRelativeTimeWithOptions: "{{val, relativetime(quarters)}}",
    },
  },
  hi: {
    translation: {
      ...
      intlCurrencyWithOptions: "मान {{val, currency(currency: USD),locale}} है",
      intlDateTime: "{{val, datetime}}",
      intlRelativeTimeWithOptions: "{{val, relativetime(days)}}",
    },
  },
